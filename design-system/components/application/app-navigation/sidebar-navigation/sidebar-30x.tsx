...
interface SidebarNavigation30xProps {
...
export const SidebarNavigation30x = ({
    activeUrl,
    items,
    footerItems = [],
    featureCard,
    ...
    const content = (
        ...
        >
            <div className="flex flex-col gap-5 px-4 lg:px-5">
                <Logo30x variant="dark" className="ml-2 h-5 self-start" />

                {/* Mobile search input */}
                <Input size="md" aria-label="Search" placeholder="Buscar candidatos..." icon={SearchLg} className="md:hidden" />

                {/* Desktop search input */}
                <Input shortcut size="sm" aria-label="Search" placeholder="Buscar candidatos..." icon={SearchLg} className="max-md:hidden" />
            </div>
    ...
    return (
        <>
            ...
            <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex">{content}</div>
        </>
    );
};
