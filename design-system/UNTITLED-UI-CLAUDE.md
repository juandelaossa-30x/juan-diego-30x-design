...
This project includes 30x branded components. The following color rules are **MANDATORY**:

### Accent Color: #E9FF7B

The **ONLY** accent yellow allowed is `#E9FF7B`. This is non-negotiable.
...
- Use alternative yellow/green shades like `#B0C259`, `#D4F542`, `#DEFF5C`
...
| Color | Hex | Usage |
|-------|-----|-------|
| Accent | `#E9FF7B` | Buttons, highlights, brand elements |
| Dark | `#262626` | Dark backgrounds, dark buttons |
| Black | `#0A0A0A` | Text on light backgrounds |
| Logo Black | `#010101` | Logo on light backgrounds |
| Light Gray | `#F2F2F2` | Logo on dark backgrounds |
| White | `#FFFFFF` | Light button backgrounds, cards |

### Usage Examples

```tsx
// ✅ CORRECT
<div className="bg-[#E9FF7B]">Base accent</div>
<div className="bg-[#E9FF7B]/50">50% opacity</div>
<div className="bg-[#E9FF7B] hover:brightness-90">Darker on hover</div>

// ❌ WRONG - Never use different yellow shades
<div className="bg-[#B0C259]">WRONG - different shade</div>
<div className="bg-[#D4F542]">WRONG - different shade</div>
<div className="bg-yellow-400">WRONG - Tailwind yellow</div>
```
